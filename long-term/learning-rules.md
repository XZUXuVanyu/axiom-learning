...
Owner: xzu. Scope: the Axiom learning and development program, including commit-triggered reviews.
...
The authoritative live checkpoint is ../progress.md and its linked active lesson. This agreement contains no independent mastery snapshot.

## Continuity and revision

Use this agreement and the latest lesson record at each continuation. Follow commit-review.md for the daily conditional check; no new commit means no lesson or reminder. Across a new conversation, provide this document or resolve the saved copy; do not promise that every future session automatically receives the entire history.
...
- 2026-09-07, v1.4: Replaced unconditional daily lessons with a daily commit check; organized durable policy in long-term/. No new commit means no action. A commit triggers assessment, not automatic advancement. Standing rules unchanged.
